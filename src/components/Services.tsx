    ...
    <section id="services" className="section-pad bg-titan-black">
      <div className="mx-auto max-w-content">
          ...
          {categories.map((cat) => {
            ...
            return (
              <article key={cat.id} className="card-glass group">
                ...
                <div className="p-6">
                  <h3 className="font-display text-xl font-semibold text-titan-silver">
                    {cat.label}
                  </h3>
                  <ul className="mt-4 space-y-2">
                    {cat.items.map((item) => (
                      <li
                        key={item}
                        className="flex gap-2 text-sm leading-snug text-titan-silver/80"
                      >
                        <span
        ...
        <aside className="mt-12 border-l-4 border-brass bg-brass/10 px-6 py-5 rounded-sm">
          <h3 className="font-display text-lg font-semibold text-titan-silver">
            The Titan Start-to-Finish Promise
          </h3>
          <p className="mt-2 max-w-3xl text-base leading-relaxed text-titan-silver/90">
